...
head:
  - - link
    - rel: canonical
      href: https://1rmb.org/tutorial/ios.html
  - - meta
    - property: og:type
      content: article
  - - meta
  ...
  - - meta
    - property: og:url
      content: https://1rmb.org/tutorial/ios.html
  - - meta
    - property: og:image
      content: https://1rmb.org/assets/1.jpg
  - - meta
    - name: twitter:card
    ...
    - |
      {
        ...
        "image": "https://1rmb.org/assets/1.jpg",
        "totalTime": "PT15M",
        "estimatedCost": {
          "@type": "MonetaryAmount",
          "currency": "USD",
        ...
        "step": [
          ...
          },
          {
            ...
            "name": "添加配置",
            "text": "通过一键导入功能添加订阅链接",
            "image": "https://1rmb.org/assets/3.jpg"
          },
          {
            "@type": "HowToStep",
            "name": "安装VPN配置",
            "text": "允许安装VPN配置文件并输入密码",
            "image": "https://1rmb.org/assets/6.jpg"
          },
          {
            "@type": "HowToStep",
            "name": "选择节点和模式",
            "text": "选择合适的节点和代理模式开始使用",
            "image": "https://1rmb.org/assets/9.jpg"
          }
        ]
      }
  - - script
    ...
    - |
      {
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://1rmb.org/tutorial/ios.html"
        }
      }
---
# 一元机场iOS客户端使用教程
